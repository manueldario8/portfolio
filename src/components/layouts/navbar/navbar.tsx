      ...
      <nav className={`navbar ${theme}`}>
        <div className="inner-nav">
          ...
          <div className={`nav-center ${isOpen ? "open" : ""}`}>
            ...
            <a href="https://github.com/manueldario8" target='_blank' className="source-icon" onClick={() => setIsOpen(false)}>
            ...
            <button onClick={toggleTheme} className='btn-hm-tg'>
              <img
            ...
            {language === "es" ? (
              <button onClick={() => setLanguage("en")} className='btn-hm-tg'>
                <img src={ENicon} className="icon" />
              </button>
            ) : (
              <button onClick={() => setLanguage("es")} className='btn-hm-tg'>
                <img src={ESicon} className="icon" />
              </button>
            )}
          </div>

          <div className="nav-right dkt-lng-btn">
